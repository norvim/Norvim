...
document.getElementById("portfolio").value =
    ...
    document.getElementById("photoPreview").src = applicant.profilePhoto; document.getElementById("photoPreview").classList.add("norvim-profile-photo");
...
document.getElementById("profileForm").addEventListener("submit", async (e) => {
    ...
    try {
        ...
        if(data.applicant.profilePhoto) {
            document.getElementById("photoPreview").src = data.applicant.profilePhoto; document.getElementById("photoPreview").classList.add("norvim-profile-photo");
        }
...
document.getElementById("profilePhoto").addEventListener("change", function () {
    ...
    if (file) {
        ...
        document.getElementById("photoPreview").src = URL.createObjectURL(file); document.getElementById("photoPreview").classList.add("norvim-profile-photo");
